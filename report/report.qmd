...
I test fatti per caratterizzare le prestazioni del codice sono stati eseguiti sulle seguenti CPU:

Name | Model | Cores | Threads | Clock speed | Cache 
--- | ----- | ----- | ------- | ----- | ----
Intel i7 | 1165G7 | 4 | 8 | 2.8 GHz | ...
Ryzen 5 | 1600 | 6 | 12 | 3.5 GHz | ...
Intel Core Ultra 7 | 255H | 8 | 16 | ... 

Tutti test preliminari, soprattutto per l'ottimizzazione del codice, come CPU verra' usata `Intel i7 1165G7` ma per i risultati piu' generali verranno usate anche le altre per confrontare i risultati finali.
Comunque in ogni caso in ogni grafico verraa' specificata la CPU usata.
...
- `Thread bentchmark`: tendo il numero di iterazioni e risoluzione fisse impone il numero di thread al programma da usare
- `Iteration bentchmark`: tenendo risoluzione e numero di thread fissi impone il numero di iterazioni da usare
- `Chunk bentchmark`: tenendo risoluzione, numero di iterazioni e nuemro di thread fissi cambia la dimensione dei chunk

Benchmark | Resolution | Iteration | # Threads | Chunk size | Sequence 
--- | --- | --- | --- | --- | ---
thread_cout_benchmark | 2048x2048 | 800 | $2^n$| default | ABBA
scale_compute_benchmark | 2048x2048 | (500 1000 2000 4000 8000) | max | default | ABBA
chunk_benchmark | 2048x2048 | 800 | max | (1 10 50 250) | ABBA
